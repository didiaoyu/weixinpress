...
function traceHttp(){
    logger('REMOTE_ADDR: '.$_SERVER['REMOTE_ADDR'].(strpos($_SERVER['REMOTE_ADDR'], '101.226') ? ' From Weixin' : ' Unkown IP'));
    ...
    <div class="wxp-option-container">
        ...
        <div class="wxp-option-sidebar">
            <div class="sidebar-box">
                ...
                <a href="http://www.houqun.me/articles/roll-out-weixinpress-plugin-for-wordpress-05.html" target="_blank">查看插件主页</a>
                <a href="http://www.houqun.me/articles/roll-out-weixinpress-plugin-for-wordpress-05.html" target="_blank">报告插件BUG</a>
